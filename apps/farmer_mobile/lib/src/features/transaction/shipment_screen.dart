        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: [
              Card(
                  child: ListTile(
                      title: const Text('Transaction State'),
                      subtitle: Text(state))),
              const ListTile(
                  leading: Icon(Icons.verified),
                  title: Text('Origin weighment verified')),
              const ListTile(
                  leading: Icon(Icons.qr_code),
                  title: Text('Pickup QR verification')),
              const ListTile(
                  leading: Icon(Icons.videocam),
                  title: Text('Loading evidence')),
              const ListTile(
                  leading: Icon(Icons.local_shipping),
                  title: Text('In transit')),
              const ListTile(
                  leading: Icon(Icons.scale),
                  title: Text('Delivery weighment')),
              const Text(
